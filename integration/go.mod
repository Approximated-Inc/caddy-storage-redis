module github.com/pberkel/caddy-storage-redis/integration
...
require (
	...
	github.com/pberkel/caddy-storage-redis v0.0.0
...
replace github.com/pberkel/caddy-storage-redis => ..

replace github.com/mholt/caddy-l4 => github.com/Approximated-Inc/caddy-l4 v0.0.0-20260811232417-40df11892606
